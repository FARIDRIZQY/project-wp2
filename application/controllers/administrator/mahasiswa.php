...
class Mahasiswa extends CI_Controller{
    ...
    public function tambah_mahasiswa_aksi()
    {
        ...
        if($this->form_validation->run() == FALSE ) {
            ...
            $jenis_kelamin  = $this->input->post('jenis_krelamin');
            $photo           = $_FILES['photo'];
            if($photo = ''){}else{
    ...
    {
        $where = array('id' => $id);
        $data['mahasiswa'] = $this->db->query("select * form mahasiwa mhs,prodi prd where mhs.nama_prodi=prd.nama_prodi and mhs.id='$id'")->result();
    ...
    public function update_mahasiswa_aksi()
    {
        ...
        if($this->form_validation->run() == FALSE)
        {
            ...
            $this->session->set_flashdata('pesan','<div class="alert alert-success alert-dismissible fade show" role="alert">
                    Data siswa Berhasil Di Update! <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                  </div>');
    ...
    public function delete($id)
    {
        ...
        Data Mahasiswa Berhasil di Hapus! <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      </div>');
        redirect('administrator/mahasiswa');
    }
